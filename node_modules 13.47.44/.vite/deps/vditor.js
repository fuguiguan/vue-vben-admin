...
// node_modules/.pnpm/vditor@3.10.4/node_modules/vditor/dist/index.min.js
var require_index_min = __commonJS({
  "node_modules/.pnpm/vditor@3.10.4/node_modules/vditor/dist/index.min.js"(exports, module) {
    !function(e, t) {
        ...
        t2.Diff = function(e3, t3) {
          ...
          for (var m = o - a, f = m % 2 != 0, h = 0, v = 0, g = 0, y = 0, b = 0; b < l && !((/* @__PURE__ */ new Date()).getTime() > i); b++) {
            ...
            for (var S = -b + g; S <= b - y; S += 2) {
              for (var L, T = s + S, M = (L = S == -b || S != b && u[T - 1] < u[T + 1] ? u[T + 1] : u[T - 1] + 1) - S; L < o && M < a && e3.charAt(o - L - 1) == r2.charAt(a - M - 1); )
                L++, M++;
              if (u[T] = L, L > o)
                y += 2;
              else if (M > a)
        ...
        var r2 = n2(478), i = n2(156), o = n2(314), a = n2(730), l = n2(66), s = n2(218), d = n2(702), c = function(e3) {
          ...
          if (void 0 === t3 && (t3 = "zh_CN"), "undefined" != typeof speechSynthesis && "undefined" != typeof SpeechSynthesisUtterance) {
            ...
            l2.voice = a2, l2.onend = l2.onerror = function() {
              ...
              var n4 = t4.target;
              if (n4.classList.contains("vditor-speech") || n4.parentElement.classList.contains("vditor-speech"))
                return o2.classList.contains("vditor-speech--current") ? speechSynthesis.speaking && (speechSynthesis.paused ? (speechSynthesis.resume(), o2.innerHTML = i2) : (speechSynthesis.pause(), o2.innerHTML = r3)) : (l2.text = o2.getAttribute("data-text"), speechSynthesis.speak(l2), o2.classList.add("vditor-speech--current"), o2.innerHTML = i2), (0, L.Hc)(window.vditorSpeechRange), void e3.focus();
          ...
          e3 && e3.querySelectorAll("a").forEach(function(e4) {
            ...
            t3 && (t3.match(/^.+.(mp4|m4v|ogg|ogv|webm)$/) ? function(e5, t4) {
              ...
              if (n3 && 11 === n3[1].length)
                e5.insertAdjacentHTML("afterend", '<iframe class="iframe__video" src="//www.youtube.com/embed/' + n3[1] + (n3[2] ? "?start=" + n3[2] : "") + '"></iframe>'), e5.remove();
              else if (i2 && i2[1])
                e5.insertAdjacentHTML("afterend", '<iframe class="iframe__video" src="//player.youku.com/embed/' + i2[1] + '"></iframe>'), e5.remove();
              else if (o && o[1])
                e5.insertAdjacentHTML("afterend", '<iframe class="iframe__video" src="https://v.qq.com/txp/iframe/player.html?vid=' + o[1] + '"></iframe>'), e5.remove();
              else if (a && a[1])
                e5.insertAdjacentHTML("afterend", '<iframe class="iframe__video"\n src="//coub.com/embed/' + a[1] + '?muted=false&autostart=false&originalSize=true&startWithHD=true"></iframe>'), e5.remove();
              else if (l && l[0])
                ...
                c && c[1] && (e5.insertAdjacentHTML("afterend", '<iframe class="iframe__video" src="//embed.ted.com/talks/' + c[1] + '"></iframe>'), e5.remove());
            }(e4, t3));
          });
        };
      }, 40: (e2, t2, n2) => {
            ...
            "dark" === n3 && (e4.theme = "dark"), mermaid.initialize(e4), d2.forEach(function(e5) {
              return l(void 0, void 0, void 0, function() {
                ...
                return s(this, function(s2) {
                  switch (s2.label) {
                    case 0:
                      if (t4 = o.mermaidRenderAdapter.getCode(e5), "true" === e5.getAttribute("data-processed") || "" === t4.trim())
                        return [2];
        ...
        var e2, t2 = n(872), i = n(54), o = n(51), a = function(e3) {
          ...
          if (e3)
            if ("html-block" !== e3.parentElement.getAttribute("data-type")) {
              ...
              if ("abc" === n2)
                (0, E.Q)(e3, t3.options.cdn);
              else if ("mermaid" === n2)
                (0, A.i)(e3, t3.options.cdn, t3.options.theme);
              else if ("markmap" === n2)
                (0, _.K)(e3, t3.options.cdn, t3.options.theme);
              else if ("flowchart" === n2)
                (0, L.P)(e3, t3.options.cdn);
              else if ("echarts" === n2)
                (0, k.p)(e3, t3.options.cdn, t3.options.theme);
              else if ("mindmap" === n2)
                (0, x.P)(e3, t3.options.cdn, t3.options.theme);
              else if ("plantuml" === n2)
                (0, H.B)(e3, t3.options.cdn);
              else if ("graphviz" === n2)
                (0, T.v)(e3, t3.options.cdn);
              else if ("math" === n2)
                (0, C.H)(e3, { cdn: t3.options.cdn, math: t3.options.preview.math });
              else {
                t3.options.customRenders.find(function(r2) {
                  if (r2.language === n2)
                    return r2.render(e3, t3), true;
        ...
        var Z, J, X = function(t3) {
          ...
          clearTimeout(e3.wysiwyg.hlToolbarTimeoutId), e3.wysiwyg.hlToolbarTimeoutId = window.setTimeout(function() {
            if ("false" !== e3.wysiwyg.element.getAttribute("contenteditable") && (0, D.Gb)(e3.wysiwyg.element)) {
              ...
              if (w2)
                return e3.wysiwyg.popover.innerHTML = "", ue(w2, e3), void le(e3, w2);
              ...
              if (E2 && (e3.wysiwyg.popover.innerHTML = "", de(t3, E2, e3), ce(t3, E2, e3), ue(E2, e3), le(e3, E2)), o2 && (e3.wysiwyg.popover.innerHTML = "", de(t3, o2, e3), ce(t3, o2, e3), ue(o2, e3), le(e3, o2)), v2) {
                ...
                var k2 = function() {
                  ...
                  if (r3 !== t4 || n3 !== i2) {
                    if (n3 !== i2)
                      for (var o3 = i2 - n3, l3 = 0; l3 < v2.rows.length; l3++)
                        if (o3 > 0)
                          for (var s3 = 0; s3 < o3; s3++)
                            0 === l3 ? v2.rows[l3].lastElementChild.insertAdjacentHTML("afterend", "<th> </th>") : v2.rows[l3].lastElementChild.insertAdjacentHTML("afterend", "<td> </td>");
                        else
                          for (var d2 = n3 - 1; d2 >= i2; d2--)
                            v2.rows[l3].cells[d2].remove();
                    if (t4 !== r3) {
                      var c2 = r3 - t4;
                      if (c2 > 0) {
                        for (var u2 = "<tr>", p2 = 0; p2 < i2; p2++)
                          u2 += "<td> </td>";
                        for (var m2 = 0; m2 < c2; m2++)
                          v2.querySelector("tbody") ? v2.querySelector("tbody").insertAdjacentHTML("beforeend", u2) : v2.querySelector("thead").insertAdjacentHTML("afterend", u2 + "</tr>");
                      } else
                        for (p2 = t4 - 1; p2 >= r3; p2--)
                          v2.rows[p2].remove(), 1 === v2.rows.length && v2.querySelector("tbody").remove();
                    }
                ...
                J2.appendChild(P2), P2.type = "number", P2.min = "1", P2.className = "vditor-input", P2.style.width = "42px", P2.style.textAlign = "center", P2.setAttribute("placeholder", window.VditorI18n.row), P2.value = v2.rows.length.toString(), P2.oninput = function() {
                  ...
                  if (!n3.isComposing)
                    return "Tab" === n3.key ? (B2.focus(), B2.select(), void n3.preventDefault()) : void (oe(e3, n3) || fe(n3, t3));
                };
                ...
                q2.appendChild(B2), B2.type = "number", B2.min = "1", B2.className = "vditor-input", B2.style.width = "42px", B2.style.textAlign = "center", B2.setAttribute("placeholder", window.VditorI18n.column), B2.value = v2.rows[0].cells.length.toString(), B2.oninput = function() {
                  ...
                  if (!n3.isComposing)
                    return "Tab" === n3.key ? (P2.focus(), P2.select(), void n3.preventDefault()) : void (oe(e3, n3) || fe(n3, t3));
              ...
              if (e3.options.comment.enable && "wysiwyg" === e3.currentMode && ("Backspace" === t4.key || P("⌘X", t4)) && e3.wysiwyg.getComments(e3), "sv" === e3.currentMode) {
                  ...
                  if (f2 || m2 && "task-marker" !== m2.nextElementSibling.getAttribute("data-type") && (f2 = m2), f2 || 0 !== l2.startOffset || !c2 || !c2.previousElementSibling || "li-marker" !== c2.previousElementSibling.getAttribute("data-type") && "task-marker" !== c2.previousElementSibling.getAttribute("data-type") || (f2 = c2.previousElementSibling), f2) {
                    ...
                    if (v2 && (g2 = f2.previousElementSibling.previousElementSibling.previousElementSibling), h2 === f2.textContent.length) {
                      if ("Enter" === t5.key && !(0, d.yl)(t5) && !t5.altKey && !t5.shiftKey && "" === f2.nextElementSibling.textContent.trim())
                        return "padding" === (null === (r2 = g2.previousElementSibling) || void 0 === r2 ? void 0 : r2.getAttribute("data-type")) ? (g2.previousElementSibling.remove(), U(e4)) : (v2 && (g2.remove(), f2.previousElementSibling.previousElementSibling.remove(), f2.previousElementSibling.remove()), f2.nextElementSibling.remove(), f2.remove(), je(e4)), t5.preventDefault(), true;
                      if ("Tab" === t5.key)
                ...
                if (function(e4, t5) {
                  ...
                  if (m2) {
                    ...
                    var h2;
                    if (P("⌘=", t5))
                      return (h2 = parseInt(m2.tagName.substr(1), 10) - 1) > 0 && (ne(e4, "h" + h2), Q(e4)), t5.preventDefault(), true;
                    if (P("⌘-", t5))
                      return (h2 = parseInt(m2.tagName.substr(1), 10) + 1) < 7 && (ne(e4, "h" + h2), Q(e4)), t5.preventDefault(), true;
  ...
  Vditor.preview(document.getElementById('preview'), e.data, {
    cdn: "` + e5.options.cdn + '",\n    markdown: {\n      theme: ' + JSON.stringify(e5.options.preview.theme) + '\n    },\n    hljs: {\n      style: "' + e5.options.preview.hljs.style + '"\n    }\n  });\n  setTimeout(() => {\n        window.print();\n    }, 3600);\n}, false);\n<\/script>'), t5.contentDocument.close(), setTimeout(function() {
          ...
          return e3.prototype.merge = function() {
            ...
            if (d2.cache.enable && !d2.cache.id)
          ...
          return e3.prototype.getComments = function(e4, t3) {
            ...
            this.unbindListener(), window.addEventListener("scroll", this.scrollListener = function() {
              ...
              if ("IMG" !== n2.target.tagName || n2.target.parentElement.classList.contains("vditor-wysiwyg__preview")) {
                ...
                if (o2)
                  return e4.options.link.click ? e4.options.link.click(o2) : e4.options.link.isOpen && window.open(o2.getAttribute("href")), void n2.preventDefault();
                var l2 = (0, D.zh)(e4);
        ...
        const Zn = function(e3) {
          function t3(t4, n2) {
            ...
            if (r2.version = i.H, "string" == typeof t4) {
              if (n2 ? n2.cache ? n2.cache.id || (n2.cache.id = "vditor" + t4) : n2.cache = { id: "vditor" + t4 } : n2 = { cache: { id: "vditor" + t4 } }, !document.getElementById(t4))
                return r2.showErrorTip("Failed to get element by id: " + t4), r2;
